...
### Treino realizado: HRR4 — 10 × 30" Z5
...
|---|---|---|
| Z1 | 8.0% | warmup |
| Z2 | 21.4% | cooldown + transições |
| Z3 | 36.1% | recuperações ativas entre sprints |
| Z4 | 32.0% | parte alta dos sprints |
| **Z5 (≥158)** | **2.5%** | ⚠️ pouco tempo na zona-alvo |
...
**Apenas 2 dos 10 sprints atingiram Z5 puro (≥158).** Os outros pararam em Z4 alto (152-157).
...
3. Quadro fisiológico aguentou: HRV 38 era um luxo, e a sessão foi feita sem furo de Z5+ (max 163, tocou Z5 sem extrapolar).
4. Recuperação entre sprints aconteceu (FC mín 67 nos descansos puros, mesmo que média intra-recuperação fosse Z3-4).

**Furo honesto (importa pra meta 4h00):**
- **Z5 só 2.5% do tempo.** O objetivo do HRR4 é desenvolver capacidade neuromuscular e VO2 max via tempo em Z5. Tocar Z5 brevemente em 2 sprints (#4 e #5) e ficar entre 152-157 no resto = **estímulo de Z4, não Z5**. Possíveis causas:
  - Sprints sub-máximos: pace 4:00-4:10/km na maioria, deveria estar **3:30-3:40/km** pra cravar Z5
  - Terreno plano (Z5 vem mais fácil em subida ou full sprint)
  - Recuperações ainda em Z3-4 (FC entre sprints 146-152): não baixou o suficiente pra o próximo sprint partir "fresco"

**Próximo HRR (provável W21 — sex 22/05 HRR6 8×1' Z5):** foco em **explosão máxima no sprint** (não economizar), recuperações ativas LEVES (caminhar/Z1 entre os esforços) pra deixar FC cair pra Z2 antes do próximo.
...
- [ ] **Sábado 16/05 — LR3 antecipado (era dom):** 10,5km Z2 base. HRV vai cair 5-10 hoje à noite — esperado, não preocupa. Pace conservador 7:30-8:00/km, FC ≤134 estrita, cadência sem cobrança absoluta (se pernas pesarem, aceita 156-158).
